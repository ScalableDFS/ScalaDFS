...
//KTDEC(balance_io_wait);
static int __init lustre_init(void)
{
	int rc;
	unsigned long lustre_inode_cache_flags;

//	ktreset(balance_io_wait);
...
//KTDEC(avail_grant_wait);
//KTDEC(dirty_page_wait);
static void __exit lustre_exit(void)
{
//	ktprint(0, ll_file_write_iter);
//	ktprint(1, avail_grant_wait);
//	ktprint(1, dirty_page_wait);
//	ktprint(1, balance_io_wait);
